...
def get_args():
	...
	parser.add_argument("--img_pth", type=str, default="/home/wei/Documents/DATA/kinship/ksframes/vi-4-21/2019-04-21-13-24-29",
...
def main():
	...
	img_pths = [os.path.join(img_pth,ls) for ls in sorted(os.listdir(img_pth))]
